...
import {FALLBACK_SAFE_INSETS} from '../constants/safeArea';

export function FundListScreen({navigation}) {
  const bottomPad = FALLBACK_SAFE_INSETS.bottom;
  ...
  return (
    <View style={styles.root}>
      ...
      />
      <View style={[styles.bar, {paddingBottom: Math.max(bottomPad, 12)}]}>
